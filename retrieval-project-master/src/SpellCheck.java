...
public class SpellCheck {
    public static String[] check(String q) throws IOException {
        String spellIndexPath = "C:\\Users\\21288\\Desktop\\新建文件夹\\retrieval-project-master\\test2";// 新索引目录
        String oriIndexPath = "C:\\Users\\21288\\Desktop\\新建文件夹\\retrieval-project-master\\test2";// 已有索引目录
